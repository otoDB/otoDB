...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='otodb.worksource'),
        ),
        migrations.AddField(
            model_name='historicalworksource',
            name='thumbnail_mime',
            field=models.IntegerField(blank=True, choices=[(1, 'image/jpeg'), (2, 'image/png'), (3, 'image/webp')], null=True),
        ),
        migrations.AddField(
            model_name='mediawork',
            name='thumbnail_source',
