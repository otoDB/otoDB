...
OTODB_DEPLOY_DOMAIN = os.environ.get('OTODB_DEPLOY_DOMAIN')
if OTODB_DEPLOY_DOMAIN:
    CORS_ALLOWED_ORIGINS.append('https://' + OTODB_DEPLOY_DOMAIN)
    CORS_ALLOWED_ORIGINS.append('http://' + OTODB_DEPLOY_DOMAIN)
    CSRF_TRUSTED_ORIGINS = ['http://' + OTODB_DEPLOY_DOMAIN, 'https://' + OTODB_DEPLOY_DOMAIN]
