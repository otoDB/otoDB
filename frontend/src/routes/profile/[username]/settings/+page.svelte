...
<Section title={m.orange_born_seal_ascend()}>
	<h2 class="mt-8 text-lg">Change Background</h2>
	<div class="mt-4 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
		<button onclick={changeBackground('none')}>
			...
			<div class="py-2 text-lg">None</div>
		</button>
		<button onclick={changeBackground('aniki')}>
			<img
				alt="aniki"
				src="/aniki-bg.png"
				class="h-48 w-full object-cover object-left object-top"
			/>
			<div class="py-2 text-lg">Aniki</div>
		</button>
	</div>
</Section>
